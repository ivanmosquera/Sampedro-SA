...
public class Detalle_Factura_ventas extends javax.swing.JFrame {
    ...
    public Detalle_Factura_ventas(int idFactura) {
        ...
        try{
            ...
            while (rs.next()){
                ...
                System.out.println("el codigo de producto es "+ cod);
    ...
    private void initComponents() {
        ...
        txt_totalpag = new javax.swing.JTextField();
        btn_imprimir_nuevamente = new javax.swing.JButton();
        ...
        btn_guardar_fact2.setFont(new java.awt.Font("Bookman Old Style", 1, 18)); // NOI18N
        ...
        txt_totalpag.setEditable(false);
        txt_totalpag.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N

        btn_imprimir_nuevamente.setFont(new java.awt.Font("Bookman Old Style", 1, 18)); // NOI18N
        btn_imprimir_nuevamente.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/impresora.png"))); // NOI18N
        btn_imprimir_nuevamente.setText("Imprimir Factura");
        btn_imprimir_nuevamente.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        btn_imprimir_nuevamente.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        btn_imprimir_nuevamente.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_imprimir_nuevamenteActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(Factura_panelLayout.createSequentialGroup()
                        ...
                        .addGroup(Factura_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(Factura_panelLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txt_saldo, javax.swing.GroupLayout.PREFERRED_SIZE, 154, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(Factura_panelLayout.createSequentialGroup()
                                .addComponent(jLabel19)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(txt_totalpag, javax.swing.GroupLayout.PREFERRED_SIZE, 154, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(Factura_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, Factura_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(btn_imprimir_nuevamente, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                            .addComponent(btn_guardar_fact, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 183, javax.swing.GroupLayout.PREFERRED_SIZE)))
            ...
            .addGroup(Factura_panelLayout.createSequentialGroup()
                ...
                .addGroup(Factura_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(Factura_panelLayout.createSequentialGroup()
                        ...
                        .addGroup(Factura_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel19)
                            .addComponent(txt_totalpag, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(20, 20, 20)
                        .addComponent(jLabel14)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addGroup(Factura_panelLayout.createSequentialGroup()
                        .addGap(17, 17, 17)
                        .addComponent(btn_imprimir_nuevamente)
                        .addGap(38, 38, 38)
    ...
    private void btn_guardar_fact2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardar_fact2ActionPerformed
        ...
        int cantidad = 0 ;
        int codigo_obtenido;
        ArrayList<String> codigo_producto = new ArrayList<String>();
        ArrayList<Integer> cantidad_producto = new ArrayList<Integer>();
        /*Neceista el id para guardar todos los productos de una factura*/
        order_list_guardar = (DefaultTableModel) Tabla_ventas.getModel();
        int numero_filas = order_list_guardar.getRowCount();
            for(i=0;i<numero_filas;i++){
                ...
                codigo_a_guardar = Tabla_ventas.getValueAt(i, 0).toString();
                cantidad = Integer.parseInt(Tabla_ventas.getValueAt(i, 3).toString());
                codigo_producto.add(codigo_a_guardar);
                cantidad_producto.add(cantidad);
                /*//factura.Guardar_Detalle_Factura(codigo_obtenido, codigo_a_guardar, cantidad); 
                inv.Ingresar_Inventario_Anulacion(codigo_a_guardar,cantidad);
                cantidad_actual = inv.get_cantidad_total_producto(codigo_a_guardar);
                nueva_cantidad = (cantidad_actual + cantidad) ;
        ...
        String cedula_enviar = txt_cedula.getText().toString();
        JOptionPane.showMessageDialog(null, "SU SALDO A FAVOR ES :"+totalsaldo+"" , "SALDO A FAVOR" , JOptionPane.INFORMATION_MESSAGE);  
        GUI_Factura_SALDO ve  = new GUI_Factura_SALDO(totalsaldo,id_de_la_factura,USUARIO,cedula_enviar,codigo_producto,cantidad_producto);
        ve.setVisible(true);
        ve.setLocationRelativeTo(null);
        ve.setResizable(false);
        dialog_motivo.dispose();
    ...
    private void btn_imprimir_nuevamenteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_imprimir_nuevamenteActionPerformed
        // TODO add your handling code here:
         priceInvoice();
    }//GEN-LAST:event_btn_imprimir_nuevamenteActionPerformed
    ...
    private void priceInvoice(){
        ...
        try {
            ...
            para.put("CLIENTE", cbx_Nombre.getText().toString());
    ...
    private javax.swing.JButton btn_imprimir_nuevamente;
    ...
    private javax.swing.JTextField txt_totalpag;
