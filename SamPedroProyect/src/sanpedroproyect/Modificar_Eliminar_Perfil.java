...
public class Modificar_Eliminar_Perfil extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Modificar_Eliminar_Perfil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Modificar_Eliminar_Perfil().setVisible(true);
            }
        });
    }
