 ...
 */
public class Detalle_Cierre_Anulada {
    String id_a ;
    String fecha_a;
    String cliente_a;
    String subtotal_a;
    ...
    public Detalle_Cierre_Anulada(String id_a, String fecha_a, String cliente_a, String subtotal_a, String total_a, String efectivo_a, String tarjeta_a) {
        this.id_a = id_a;
